            ...
            <div className="review__container">
                <div className="review__one">
                    ...
                    <div className="review__one-content">
                        ...
                        <div className="one-content__card">
                            <img src="/src/assets/icon-09.png" alt="icon-08" />
                            <span>4x</span>
                            <p>Revenue Growth</p>
                        </div>
                        <div className="one-content__card">
                ...
                <div className="review__two">
                    ...
                    <div className="review__two-card">
                        <p>
                            ...
                            Phasellus rhoncus eu
                            tincidunt auctor nullam
                            rutrum, pharetra augue.”
                        </p>
                        <h2>Coriss Ambady</h2>
                        <p>Financial Analyst</p>
                    </div>
